...
<pre style="position: relative;"><strong>Input:</strong> words = ["aba","aabb","abcd","bac","aabc"]
...
<pre style="position: relative;"><strong>Input:</strong> words = ["aabb","ab","ba"]
...
<pre style="position: relative;"><strong>Input:</strong> words = ["nba","cba","dba"]
<strong>Output:</strong> 0
<strong>Explanation:</strong> Since there does not exist any pair that satisfies the conditions, we return 0.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
