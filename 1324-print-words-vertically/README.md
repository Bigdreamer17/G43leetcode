...
<pre style="position: relative;"><strong>Input:</strong> s = "HOW ARE YOU"
...
<pre style="position: relative;"><strong>Input:</strong> s = "TO BE OR NOT TO BE"
...
<pre style="position: relative;"><strong>Input:</strong> s = "CONTEST IS COMING"
