...
<pre style="position: relative;"><strong>Input:</strong> nums = [2,5,6,9,10]
...
<pre style="position: relative;"><strong>Input:</strong> nums = [7,5,6,8,3]
...
<pre style="position: relative;"><strong>Input:</strong> nums = [3,3]
